...
export const projects: Project[] = [
  ...
  },
  {
    ...
    decisions: ['Classer le projet en fullstack pour préserver les projets métier hors archives', 'Ne pas ajouter de démo sans URL publiée fiable'],
    impact: 'Complète le portfolio avec un cas métier boutique, sans le présenter comme projet majeur.',
  ...
  },
  {
    ...
    decisions: ['Classer l’outil dans les utilitaires', 'Conserver le visuel de repli tant qu’aucune capture dédiée n’est ajoutée manuellement'],
