...
export const DetailGrid = styled.div`display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; margin: 18px 0; @media(max-width:760px){grid-template-columns:1fr;}`;
